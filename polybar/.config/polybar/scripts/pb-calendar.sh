#!/bin/sh
#
# pb-calendar - 0.0.1 - June  4, 2019 @  9:43 am
# created: June  4, 2019 @  9:43 am by Cory G
# license: gpl-2.0
#
#        __                      __                __
# .-----|  |--.______.----.---.-|  .-----.-----.--|  .---.-.----.
# |  _  |  _  |______|  __|  _  |  |  -__|     |  _  |  _  |   _|
# |   __|_____|      |____|___._|__|_____|__|__|_____|___._|__|
# |__|
#
# *******************************
# A script I've stupidly left with the default description and vaguely named pb-calendar
# ------------------------------------------
#
# contact
# -------
